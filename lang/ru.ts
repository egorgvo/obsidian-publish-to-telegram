export default {
    ...
    SETTING_ADD_CHANNEL_DESC: "Войдите в аккаунт Telegram в разделе выше, затем добавьте пресет с ID или @username канала/группы, в которые хотите публиковать.",
    ...
    SETTING_CHAT_ID_NAME: "Целевой канал/группа",
    SETTING_CHAT_ID_DESC: "Числовой ID (например -100123456789) или @username",
    ...
    SETTING_MD_EMBEDS_AS_COMMENTS_DESC: "Если включено, после публикации будет отправлен комментарий к посту с содержимым .md-вложения",

...
6. Опционально включайте автоматическое сохранение ссылки на опубликованный пост в свойства заметки.

7. Открывайте справку по форматированию либо из настроек плагина, либо из палитры команд.
...
1. С помощью официального инструмента Telegram [@BotFather](https://t.me/BotFather) создайте свой личный бот, следуя инструкциям в приложении.

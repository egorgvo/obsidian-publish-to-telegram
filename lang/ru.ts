...
2. Скопируйте целевой @username или ID. Узнать ID любогов пользователя, канала или группы можно у @userinfobot.
3. Создайте новый пресет и вставьте @nickname или ID в поле "Целевой канал, группа или пользователь".`,
...
1. Войдите в аккаунт Telegram в разделе **Аккаунт Telegram** в настройках плагина. Доступна облачная авторизация (только номер телефона) или вход с собственными API-ключами с [my.telegram.org](https://my.telegram.org).

2. Добавьте новый пресет и введите числовой ID или @username канала/группы, куда вы планируете публиковать посты. ID канала/группы можно найти в информации о канале/группе в приложении Telegram.
...
2. Если комментарий к посту будет опубликован на канале, то к каналу должен быть привязан чат с обсуждениями. Если комментарий к посту будет опубликован в группе, то он отобразится как обычный ответ на сообщение.

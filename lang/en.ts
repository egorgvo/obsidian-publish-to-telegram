export default {
    ...
    NOTICE_ERR_TOO_LONG_TEXT: "Error: Post must be less than 4096 symbols.",
    NOTICE_ERR_TOO_LONG_CAPTION: "Error: Post with media attachments must be less than 1024 symbols.",

...
Поддерживаются вложения в виде медиа, альбомов (групп медиа) и документов. Чтобы прикрепить файл к посту, используйте стандартную функцию встраивания в Obsidian:

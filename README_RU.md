...
| Результат в Telegram        | Ввод в Obsidian                           |
| ----------------------------| ----------------------------------------- |
| **Полужирный**              | `**Полужирный**`                          |
| _Курсив_                    | `*Курсив*`                                |
| **Подчёркивание**           | `<u>Подчёркивание</u>`                    |
| ~~Зачёркивание~~            | `~~Зачёркивание~~`                        |
| Спойлер*                    | `<span class="tg-spoiler">Спойлер</span>` |
| `Код в строке`              | `` `Код в строке` ``                      |
| [Ссылка](https://obsdian.md)| `[Ссылка](url)`                           |
| Цитата                      | `> Цитата`                                |
| Блок кода                   | `` ```Блок кода``` ``                     |
| Список*                     | `- Список`                                |
| Заголовок*                  | `# Заголовок`                             |

*Невозможно отобразить на GitHub, но оно будет отображаться в Telegram

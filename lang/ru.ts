export default {
    ...
    NOTICE_ERR_TOO_LONG_TEXT: "Ошибка: Пост должен быть менее 4096 символов.",
    NOTICE_ERR_TOO_LONG_CAPTION: "Ошибка: Пост с медиавложениями должен быть менее 1024 символов.",

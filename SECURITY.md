...
The only supported version of the plugin is always the [lastest](https://github.com/pan4ratte/obsidian-publish-to-telegram/releases/latest) public release.

## Reporting a Vulnerability

To report a vulnerability, use [Security tab](https://github.com/pan4ratte/obsidian-publish-to-telegram/security) in the repository.
